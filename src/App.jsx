...
.os-badge{position:absolute;top:12px;right:12px;font-size:10px;font-weight:700;padding:3px 9px;border-radius:4px;text-transform:uppercase}
...
.btn-devis{background:var(--bleu);color:#fff;border:none;padding:9px 18px;border-radius:8px;font-size:12.5px;font-weight:600;cursor:pointer;transition:var(--tr);font-family:inherit}
...
.real-lieu{font-size:11px;color:var(--vert3);font-weight:600;margin-bottom:5px}
...
.blog-meta{font-size:11px;color:var(--g600)}
...
.ct-form-t{font-family:'Poppins',sans-serif;font-size:17px;font-weight:700;color:var(--g900);margin-bottom:20px}
...
.cart-hd h3{font-weight:700;font-size:16px;color:var(--g900)}
.cart-x{width:33px;height:33px;border-radius:50%;background:var(--g100);border:none;cursor:pointer;font-size:16px;display:flex;align-items:center;justify-content:center;color:var(--g700)}
...
.ci-inf{flex:1}
.ci-nm{font-size:13px;font-weight:600;color:var(--g900);margin-bottom:3px}
.ci-q{font-size:11px;color:var(--g600)}
.ci-rm{background:none;border:none;cursor:pointer;color:var(--g600);font-size:15px;padding:4px}
.ci-rm:hover{color:#dc2626}
.cart-ft{padding:15px 22px;border-top:1px solid var(--g200)}
.cart-ft-btn{width:100%;padding:12px;background:var(--bleu);color:#fff;border:none;border-radius:9px;font-weight:700;font-size:13.5px;cursor:pointer;font-family:inherit}
...
.info-box{background:linear-gradient(135deg,#e8f0fe,#e8f5e9);border:1px solid #c7d7fc;border-radius:12px;padding:20px 24px;margin-bottom:32px}
...
const OSMOSEURS=[
  {id:1,debit:"500 L/h",nom:"Osmoseur Industriel 500 L/h",desc:"Unité compacte idéale pour petites industries, cliniques, hôtels et laboratoires. Facile d'installation, faible encombrement.",prix:"48 000 MAD HT",badge:"",specs:["Pression : 10–15 bar","Rejection : >97%","Châssis inox 304","Garantie 2 ans","Livraison Maroc"],img:"/osmoseur-petit.webp"},
  {id:2,debit:"1 m³/h",nom:"Osmoseur Industriel 1 m³/h",desc:"Pour industries agroalimentaires, laboratoires et structures médicales. Rendement optimal et faible consommation énergétique.",prix:"82 500 MAD HT",badge:"pop",specs:["Pression : 10–15 bar","Rejection : >97%","Préfiltre sédiment","Compteur débitmètre","Alarme défaut perméat"],img:"/osmoseur-petit.webp"},
  {id:3,debit:"2 m³/h",nom:"Osmoseur Industriel 2 m³/h",desc:"Capacité moyenne pour industries manufacturières, agro-industrie et collectivités. Contrôle automatique de qualité.",prix:"109 500 MAD HT",badge:"",specs:["Pression : 12–16 bar","Rejection : >98%","Contrôleur conductivité","Vanne bypass auto","Afficheur digital"],img:"/osmoseur-moyen.webp"},
  {id:4,debit:"3 m³/h",nom:"Osmoseur Industriel 3 m³/h",desc:"Unité robuste pour industries lourdes, collectivités et sites de production. Système CIP intégré pour nettoyage en place.",prix:"120 000 MAD HT",badge:"",specs:["Pression : 12–16 bar","Rejection : >98%","Membranes 8040","Système CIP","Enregistreur données"],img:"/osmoseur-moyen.webp"},
  {id:5,debit:"4 m³/h",nom:"Osmoseur Industriel 4 m³/h",desc:"Idéal pour grandes industries alimentaires, chimiques et pharmaceutiques. Châssis inox 316L anticorrosion.",prix:"128 000 MAD HT",badge:"best",specs:["Pression : 14–18 bar","Rejection : >98%","Châssis inox 316L","Écran tactile","Double pass disponible"],img:"/osmoseur-grand.webp"},
  {id:6,debit:"6 m³/h",nom:"Osmoseur Industriel 6 m³/h",desc:"Système semi-industriel pour grandes unités de production. Récupérateur d'énergie et système d'alarme complet.",prix:"183 500 MAD HT",badge:"",specs:["Pression : 14–18 bar","Rejection : >98%","Récupérateur énergie","Alarme automatique","Télésurveillance 4G"],img:"/osmoseur-grand.webp"},
  {id:7,debit:"8 m³/h",nom:"Osmoseur Industriel 8 m³/h",desc:"Haute capacité pour dessalement et industries lourdes. Double train de membranes pour continuité de service.",prix:"194 300 MAD HT",badge:"pro",specs:["Pression : 15–20 bar","Rejection : >99%","Double train membranes","SCADA / Automate","Maintenance préventive incluse"],img:"/osmoseur-industriel.webp"},
  {id:8,debit:"10 m³/h",nom:"Osmoseur Industriel 10 m³/h",desc:"Unité haute performance pour grandes STEP et industries. Solution clé en main avec formation des opérateurs et SAV UEM.",prix:"230 000 MAD HT",badge:"pro",specs:["Pression : 15–20 bar","Rejection : >99%","Clé en main complet","SCADA temps réel","SAV UEM 12 mois inclus"],img:"/osmoseur-industriel.webp"}
];

const REACTIFS={
  "Coagulants & Floculants":[
    {id:1,nom:"PAC — Poly Aluminium Chlorure",desc:"Coagulant liquide haute performance. Efficace sur large plage de pH (5,5 à 9). Utilisé en STEP, eau potable et effluents industriels.",type:"Coagulant",emoji:"🧪"},
    {id:2,nom:"Chlorure Ferrique FeCl₃",desc:"Coagulant minéral puissant pour eaux industrielles et boues. Excellent pour déphosphatation.",type:"Coagulant",emoji:"🧪"},
    {id:3,nom:"Sulfate d'Aluminium",desc:"Coagulant classique pour eau potable et eaux résiduaires. Disponible en poudre et en solution.",type:"Coagulant",emoji:"🧪"},
    {id:4,nom:"Floculant Anionique",desc:"Polyacrylamide anionique pour clarification des eaux chargées. Disponible en plusieurs viscosités.",type:"Floculant",emoji:"🔬"},
    {id:5,nom:"Floculant Cationique",desc:"Polyacrylamide cationique pour conditionnement des boues avant filtration et centrifugation.",type:"Floculant",emoji:"🔬"}
  ],
  "Correction pH & Désinfection":[
    {id:6,nom:"Acide Chlorhydrique HCl dilué",desc:"Correction acide du pH des effluents alcalins et nettoyage des membranes. Concentration 33%.",type:"Correction pH",emoji:"⚗️"},
    {id:7,nom:"Soude Caustique NaOH",desc:"Correction basique du pH des effluents acides. Disponible en solution (30–50%) et en pastilles.",type:"Correction pH",emoji:"⚗️"},
    {id:8,nom:"Hypochlorite de Sodium NaOCl",desc:"Désinfectant oxydant puissant. Élimine bactéries, virus et algues. Disponible en fûts 25L.",type:"Désinfection",emoji:"💊"},
    {id:9,nom:"Peroxyde d'Hydrogène H₂O₂",desc:"Oxydant puissant. Élimine DCO, H₂S et composés organiques réfractaires. Traitement écologique.",type:"Désinfection",emoji:"💊"},
    {id:10,nom:"Antimousse Industriel",desc:"Élimine les mousses dans les bassins d'aération, STEP et circuits industriels. Non toxique.",type:"Divers",emoji:"🫧"}
  ],
  "Osmose Inverse & Chaudière":[
    {id:11,nom:"Anti-Scalant Membranes OI",desc:"Prévient l'entartrage des membranes d'osmose inverse. Compatible toutes membranes du marché.",type:"OI",emoji:"🛡️"},
    {id:12,nom:"Nettoyant Membranes Acide",desc:"Nettoyage acide des membranes OI pour éliminer incrustations minérales et biofilm.",type:"OI",emoji:"🛡️"},
    {id:13,nom:"Nettoyant Membranes Basique",desc:"Nettoyage alcalin des membranes OI pour éliminer fouling organique et biologique.",type:"OI",emoji:"🛡️"},
    {id:14,nom:"Métabisulfite de Sodium",desc:"Neutralisant du chlore résiduel avant les membranes OI. Protège les membranes des oxydants.",type:"OI",emoji:"🛡️"},
    {id:15,nom:"Antitartre Chaudière",desc:"Prévient les dépôts calcaires dans les chaudières. Améliore le rendement thermique.",type:"Chaudière",emoji:"🔥"},
    {id:16,nom:"Produit de Passivation",desc:"Protège la surface interne des chaudières contre la corrosion. Neutralisation oxygène dissous.",type:"Chaudière",emoji:"🔥"}
  ]
};

const SERVICES_DETAIL=[
  {id:"step",titre:"Conception & Dimensionnement STEP",cat:"Ingénierie",tag:"tag-ing",emoji:"🏗️",img:"/Step-traitement.jpg.jpeg",
  ...
  {id:"optim",titre:"Optimisation STEP Existantes",cat:"Ingénierie",tag:"tag-ing",emoji:"⚙️",img:"/bassin-desinfection.jpg.jpeg",
  ...
  {id:"analyse-eau",titre:"Analyse Physicochimique & Bactériologique",cat:"Analyse certifiée",tag:"tag-ana",emoji:"🔬",img:"/Laboratoire-uem.jpg.jpeg",
  ...
  {id:"analyse-sol",titre:"Analyse Agronomique des Sols",cat:"Analyse certifiée",tag:"tag-ana",emoji:"🌍",img:"/analyse -terrain.jpg.jpeg",
  ...
  {id:"hse",titre:"Études d'Impact & Audits HSE",cat:"Environnement",tag:"tag-ing",emoji:"🌿",img:"/mesure-site.jpg.jpeg",
  ...
  {id:"ingenierie",titre:"Solutions Traitement des Eaux Clé en Main",cat:"Ingénierie",tag:"tag-ing",emoji:"💧",img:"/Step-traitement.jpg.jpeg",
...
const ARTICLES_DEFAULT=[
  {id:"d1",titre:"Traitement des eaux usées industrielles : nouvelles normes NM 2024",resume:"Les dernières évolutions réglementaires marocaines en matière de traitement des effluents industriels et leurs impacts sur les entreprises.",date:"Juin 2024",cat:"Réglementation",emoji:"📋"},
  {id:"d2",titre:"Osmoseur industriel : guide complet pour choisir votre système",resume:"Capacité, membranes, pression, énergie : tous les critères pour sélectionner le bon système d'osmose inverse pour votre industrie.",date:"Mai 2024",cat:"Guide",emoji:"💧"},
...
const ADVANTAGES=[
  ...
  {icon:"🎯",title:"Solutions sur mesure",desc:"Études personnalisées adaptées à chaque contexte industriel et budgétaire"},
  {icon:"💡",title:"Innovation continue",desc:"Technologies de pointe pour répondre aux défis environnementaux les plus complexes"},
  {icon:"🤝",title:"Accompagnement global",desc:"De l'étude initiale à la maintenance, UEM reste à vos côtés à chaque étape"}
];
const HERO_SLIDES=[
...
const PRODUCTS_CAR=[
  {id:1,emoji:"🧫",title:"Réactifs laboratoire",img:null,page:"reactifs"},
  {id:2,emoji:"🛢️",title:"Produits chimiques eaux",img:null,page:"reactifs"},
  {id:3,emoji:"💠",title:"Osmoseurs industriels",img:"/osmoseur-grand.webp",page:"osmoseurs"},
  {id:4,emoji:"🏠",title:"Osmoseurs domestiques",img:"/osmoseur-petit.webp",page:"osmoseurs"},
  {id:5,emoji:"🔵",title:"Adoucisseurs d'eau",img:null,page:"osmoseurs"},
  {id:6,emoji:"📦",title:"Consommables",img:null,page:"reactifs"},
  {id:7,emoji:"⚗️",title:"Produits HSE",img:null,page:"reactifs"},
  {id:8,emoji:"🔬",title:"Équipements mesure",img:null,page:"reactifs"}
];
...
export default function App() {
  ...
  const addCart = useCallback((item) => {
    ...
    toast(`${item.emoji||"💠"} ${item.nom||item.title} ajouté`);
  }, [toast]);
  ...
  const handleSubmit = async () => {
    ...
    } catch { toast("Erreur. Contactez-nous au +212 523 37 74 17","❌"); }
    setSending(false);
  };
  ...
  const SHARED = {nav, scrollTo, cart, setCartOpen, mobOpen, setMobOpen, page, toast, addCart};
  ...
  const WALink = ({cls}) => (
    <a className={cls||"btn-wa-s"} href="https://wa.me/212700090365" target="_blank" rel="noopener noreferrer">
  ...
  const TB = () => (
    <div className="tb"><div className="tb-in">
      <div className="tb-l">
        <a className="tb-a" href="tel:+212523377417"><svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10.8 19.79 19.79 0 01.55 2.18 2 2 0 012.55 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.06 6.06l.91-.91a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>+212 523 37 74 17</a>
        <a className="tb-a" href="https://wa.me/212700090365" target="_blank" rel="noopener noreferrer"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>+212 700 090 365</a>
        <span className="tb-a"><svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>N°1, Bd Jabrane Khalil Jabrane, El Jadida</span>
        <a className="tb-a" href="mailto:univers.env@gmail.com"><svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>univers.env@gmail.com</a>
      </div>
    ...
    <nav className="nb"><div className="nb-in">
      ...
      <ul className="nb-links">
        ...
        <li className="nb-item">
          ...
          <div className="dd">
            {[["💧","Traitement des eaux"],["🧪","Analyses NM/ISO"],["📐","Ingénierie & Conception"],["🌿","Environnement & HSE"],["🎓","Formation"],["🔧","Maintenance & SAV"]].map(([e,t],i) => (
              <button key={i} className="dd-btn" onClick={() => nav("services")}><span className="dd-ico">{e}</span>{t}</button>
            ))}
          </div>
        </li>
        <li className="nb-item">
          ...
          <div className="dd">
            <button className="dd-btn" onClick={() => nav("osmoseurs")}><span className="dd-ico">💠</span>Osmoseurs industriels</button>
            <button className="dd-btn" onClick={() => nav("reactifs")}><span className="dd-ico">⚗️</span>Réactifs chimiques</button>
            <button className="dd-btn" onClick={() => nav("osmoseurs")}><span className="dd-ico">🔵</span>Adoucisseurs d'eau</button>
            <button className="dd-btn" onClick={() => nav("reactifs")}><span className="dd-ico">🔬</span>Équipements de mesure</button>
          </div>
        </li>
      ...
      <button style={{background:"none",border:"none",cursor:"pointer",padding:"8px",display:"flex",alignItems:"center",gap:4,color:"var(--g700)",fontSize:13,fontFamily:"inherit",fontWeight:500,flexShrink:0}} onClick={() => setCartOpen(true)}>
  ...
  const AI = () => (
    <div className="ai-fl">
      <div className={`ai-win${aiOpen?" open":""}`}>
        <div className="ai-hd"><div className="ai-av">🤖</div><div><div className="ai-nm">Assistant UEM</div><div className="ai-st">● En ligne</div></div><button className="ai-cx" onClick={() => setAiOpen(false)}>✕</button></div>
      ...
      <button className="ai-tog" onClick={() => setAiOpen(o=>!o)}>🤖</button>
    </div>
  );
        ...
        <div className="cart-body">
          ...
          : cart.map(item => (
            <div className="ci" key={item.id}>
              ...
              <div className="ci-inf"><div className="ci-nm">{item.nom||item.title}</div><div className="ci-q">Qté: {item.qty}</div></div>
              <button className="ci-rm" onClick={() => setCart(c=>c.filter(x=>x.id!==item.id))}>🗑️</button>
            </div>
          ))}
        </div>
        {cart.length>0 && <div className="cart-ft"><button className="cart-ft-btn" onClick={() => {toast("Demande envoyée ! Nous vous contactons sous 24h.","📩");setCart([]);setCartOpen(false);}}>Demander un devis →</button></div>}
      </div>
    </div>
  );

  const TOASTS = () => <div className="toast-wr">{toasts.map(t => <div key={t.id} className="toast">{t.icon} {t.msg}</div>)}</div>;
          ...
          <div className="frow">
            ...
            <div className="fg"><label>Service souhaité</label>
              <select value={form.service} onChange={e=>setForm(f=>({...f,service:e.target.value}))}>
                ...
                <option value="Osmoseur industriel">Osmoseur industriel</option>
  ...
  if (page === "osmoseurs") return (
    <div>
      ...
      <div className="pbody">
        ...
        <h2 style={{fontFamily:"'Poppins',sans-serif",fontSize:"18px",fontWeight:700,marginBottom:16,color:"var(--g900)"}}>📊 Tableau comparatif des modèles</h2>
        <div className="os-compare">
          <table className="os-table">
            ...
            <tbody>
              {OSMOSEURS.map(o => (
                <tr key={o.id}>
                  <td style={{fontWeight:600}}>{o.debit}</td>
                  ...
                  <td><button className="btn-devis" onClick={() => scrollTo("contact")}>Devis</button></td>
                </tr>
              ))}
            </tbody>
          </table>
          ...
          {OSMOSEURS.map(o => (
            <div className={`os-card${o.badge==="best"?" featured":""}`} key={o.id}>
              <div className="os-img">
                {o.img?<img src={o.img} alt={o.nom} onError={e=>e.target.style.display="none"}/>:<div className="os-img-ph">💠</div>}
                {o.badge==="best"&&<span className="os-badge best">⭐ Meilleure vente</span>}
                {o.badge==="pop"&&<span className="os-badge pop">🔥 Populaire</span>}
              ...
              <div className="os-body">
                ...
                <div className="os-foot">
                  ...
                  <div style={{display:"flex",gap:7}}>
                    <button className="btn-panier" onClick={() => addCart({...o,id:`os-${o.id}`,emoji:"💠",title:o.nom})}>🛒</button>
                    <button className="btn-devis" onClick={() => scrollTo("contact")}>Devis</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <CONTACT_SECTION/><FT/><CART/><AI/><WA/><TOASTS/>
    </div>
  );
  ...
  if (page === "reactifs") return (
    <div>
      ...
      <div className="pbody">
        <div className="info-box">
          <p>⚗️ <strong>Stock permanent à El Jadida</strong> — Tous nos réactifs sont stockés localement pour une livraison rapide. <strong>Tarifs sur devis</strong> selon les quantités. Conditionnements : bidons 25L, fûts 200L, IBC 1000L. Fiche de données de sécurité (FDS) fournie pour chaque produit.</p>
        </div>
              ...
              <div className="chim-cards">
                {prods.map(p => (
                  <div className="chim-card" key={p.id}>
                    <div className="chim-ph">{p.emoji}</div>
                    <div className="chim-body">
                      ...
                      <div className="chim-foot">
                        ...
                        <button className="btn-chim" onClick={() => scrollTo("contact")}>Demander prix</button>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          {SERVICES_DETAIL.map(s => (
            <div className="svc-det-card" key={s.id} onClick={() => nav(`svc-${s.id}`)}>
              <div className="svc-det-img">
                {s.img?<img src={s.img} alt={s.titre} onError={e=>e.target.style.display="none"}/>:<div className="svc-det-ph">{s.emoji}</div>}
        ...
        <div className="pbody">
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:12,marginBottom:36}}>
            {s.feats.map((f,i) => (
              <div key={i} style={{background:"var(--g50)",border:"1px solid var(--g200)",borderRadius:10,padding:"13px 16px",display:"flex",alignItems:"center",gap:10}}>
                <span style={{color:"var(--vert3)",fontSize:16,fontWeight:700,flexShrink:0}}>✓</span>
          ...
          <div style={{background:"linear-gradient(135deg,var(--bleu),var(--bleu2))",borderRadius:16,padding:"32px",textAlign:"center",marginTop:36}}>
            ...
            <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap"}}>
              <button className="btn-prim" style={{background:"#fff",color:"var(--bleu)"}} onClick={() => scrollTo("contact")}>Demander un devis gratuit →</button>
              <a className="btn-wa-s" href="https://wa.me/212700090365" target="_blank" rel="noopener noreferrer"><svg width="15" height="15" viewBox="0 0 24 24" fill="white"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>Parler à un expert</a>
            </div>
          </div>
        </div>
        <FT/><CART/><AI/><WA/><TOASTS/>
      </div>
    );
  }
            ...
            {filtered.map(r => (
              <div className="real-card" key={r.id}>
                <div className="real-img">
                  {r.img?<img src={r.img} alt={r.titre} onError={e=>e.target.style.display="none"}/>:<div className="real-img-ph">🏗️</div>}
        ...
        <div className="hero-in">
          <div>
            ...
            <div className="hero-trust">
              {[{i:"⏱️",t:"Réponse < 24h"},{i:"🏅",t:"Experts certifiés"},{i:"📋",t:"Normes NM / ISO"},{i:"🚀",t:"Tout le Maroc"}].map((x,i)=><div className="tr-item" key={i}><span>{x.i}</span>{x.t}</div>)}
            </div>
          </div>
            ...
            <div className="slider">
              {HERO_SLIDES.map((s,i) => (
                <div key={i} className={`slide${i===slideIdx?" on":""}`} style={{background:s.bg}}>
                  ...
                  {!s.img&&<div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",fontSize:100,opacity:.18}}>{s.emoji}</div>}
                </div>
              ))}
            ...
            {SERVICES.map(s => (
              <div className="svc-card" key={s.id} onClick={() => nav("services")}>
                ...
                <div className="svc-body">
                  <div className="svc-hd"><div className="svc-ico" style={{background:s.bg,color:s.color}}>{s.emoji}</div><div className="svc-nt">{s.title}</div></div>
            ...
            <div className="car-tr">
              {PRODUCTS_CAR.slice(carOff).concat(PRODUCTS_CAR.slice(0,carOff)).map(p => (
                <div className="prod-card" key={p.id} onClick={() => nav(p.page)}>
                  ...
                  <div className="pc-ph" style={{display:p.img?"none":"flex"}}>{p.emoji}</div>
  ...
  if (!auth) return (
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#f8fafc",fontFamily:"Inter,sans-serif"}}>
      <div style={{background:"#fff",borderRadius:18,padding:"42px 34px",boxShadow:"0 8px 40px rgba(0,0,0,.12)",width:355,textAlign:"center"}}>
        ...
        <button style={{width:"100%",padding:12,background:"#0d2b6e",color:"#fff",border:"none",borderRadius:9,fontWeight:700,fontSize:14,cursor:"pointer",fontFamily:"inherit"}} onClick={()=>pwd==="uem-admin-2026"?setAuth(true):toast("Mot de passe incorrect","❌")}>Se connecter</button>
        ...
        <div className="adm-bd">
          <div className="adm-sec">
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:12,marginBottom:12}}>
              <div className="fg" style={{marginBottom:0}}><label style={{fontSize:11.5,fontWeight:600,color:"var(--g700)"}}>Extrait *</label><textarea style={{height:72}} placeholder="Résumé..." value={blogForm.excerpt} onChange={e=>setBlogForm(f=>({...f,excerpt:e.target.value}))}/></div>
              <div className="fg" style={{marginBottom:0}}><label style={{fontSize:11.5,fontWeight:600,color:"var(--g700)"}}>Emoji</label><input style={{width:64,textAlign:"center",fontSize:22}} value={blogForm.emoji} onChange={e=>setBlogForm(f=>({...f,emoji:e.target.value}))}/></div>
            </div>
          ...
          <div className="adm-sec">
            ...
            :blogs.map(post=><div className="bpi" key={post.id}><div><div style={{display:"flex",alignItems:"center",gap:7,marginBottom:3}}><span>{post.emoji}</span><strong style={{fontSize:13.5}}>{post.title}</strong></div><div className="bpi-m">{post.category} — {post.date}</div></div><button className="btn-del" onClick={()=>{setBlogs(b=>b.filter(x=>x.id!==post.id));toast("Supprimé","🗑️");}}>Supprimer</button></div>)}
          </div>
          <div className="adm-sec">
            <h2>ℹ️ Système</h2>
